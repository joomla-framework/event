...
Add `"joomla/event": "~4.0"` to the require block in your composer.json and then run `composer install`.
...
```sh
composer require joomla/event "~4.0"
```

If you want to include the test sources and docs, use

```sh
composer require --prefer-source joomla/event "~4.0"
```
